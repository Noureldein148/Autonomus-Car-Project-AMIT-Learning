...
void SERVO_negative90Degree(void)
{
	...
	TMR_timer1_setCompareMatchAValue(175); // duty cycle 1ms
	TMR_timer1Enable();
}
...
{
	TMR_timer1InitFastPWM();
	TMR_timer1_setCompareMatchAValue(65);  //duty cycle 1.5ms
	TMR_timer1Enable();
}
...
{
	TMR_timer1InitFastPWM();
	TMR_timer1_setCompareMatchAValue(300);  //duty cycle 2ms
	TMR_timer1Enable();
}
